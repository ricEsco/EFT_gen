...
def process_event(entry, histograms, relevant_pdgIds):
    ...
    entry.SetBranchAddress("LHEWeight_ctGRe_0p_cQj18_0p_cQj38_0p_cQj11_0p_cjj31_0p_ctu8_0p_ctd8_0p_ctj8_0p_cQu8_0p_cQd8_0p_ctu1_0p_ctd1_0p_ctj1_0p_cQu1_0p_cQd1_0p", lhe_weight_0)
    entry.SetBranchAddress("LHEWeight_ctGRe_1p_cQj18_0p_cQj38_0p_cQj11_0p_cjj31_0p_ctu8_0p_ctd8_0p_ctj8_0p_cQu8_0p_cQd8_0p_ctu1_0p_ctd1_0p_ctj1_0p_cQu1_0p_cQd1_0p", lhe_weight_1)
            ...
            if abs(pdgId) == 6:
                ...
                if len(w_quarks) == 2:
                    ...
                    if 65 < hadronic_w_mass < 95: # I include this line to ensure that the events are indeed hadronic W decays
                        ...
                        histograms['h_hadronic_w_mass_weightSM'].Fill(hadronic_w_mass, lhe_weight_0[0])
                        histograms['h_hadronic_w_mass_ctGRe'].Fill(hadronic_w_mass, lhe_weight_1[0])
    ...
    if len(w_quarks) == 2:
        for lepton in leptons:
            ...
            histograms['h_leptonPt_weightSM'].Fill(lepton_pt, lhe_weight_0[0])
            histograms['h_leptoneta_weightSM'].Fill(lepton_eta, lhe_weight_0[0])
            histograms['h_leptonphi_weightSM'].Fill(lepton_phi, lhe_weight_0[0])
            histograms['h_leptonFlavor_weightSM'].Fill(entry.GenPart_pdgId[k], lhe_weight_0[0])
            
            histograms['h_leptonPt_ctGRe'].Fill(lepton_pt, lhe_weight_1[0])
            histograms['h_leptoneta_ctGRe'].Fill(lepton_eta, lhe_weight_1[0])
            histograms['h_leptonphi_ctGRe'].Fill(lepton_phi, lhe_weight_1[0])
            histograms['h_leptonFlavor_ctGRe'].Fill(entry.GenPart_pdgId[k], lhe_weight_1[0])
            
            if abs(lepton_pdgId) == 11:
                histograms['h_electronPt'].Fill(lepton_pt)
                histograms['h_electroneta'].Fill(lepton_eta)
                
                histograms['h_electronPt_weightSM'].Fill(lepton_pt, lhe_weight_0[0])
                histograms['h_electroneta_weightSM'].Fill(lepton_eta, lhe_weight_0[0])
                
                histograms['h_electronPt_ctGRe'].Fill(lepton_pt, lhe_weight_1[0])
                histograms['h_electroneta_ctGRe'].Fill(lepton_eta, lhe_weight_1[0])
                                    
            elif abs(lepton_pdgId) == 13:
                histograms['h_muonPt'].Fill(lepton_pt)
                histograms['h_muoneta'].Fill(lepton_eta)
                
                histograms['h_muonPt_weightSM'].Fill(lepton_pt, lhe_weight_0[0])
                histograms['h_muoneta_weightSM'].Fill(lepton_eta, lhe_weight_0[0])
                
                histograms['h_muonPt_ctGRe'].Fill(lepton_pt,lhe_weight_1[0])
                histograms['h_muoneta_ctGRe'].Fill(lepton_eta, lhe_weight_1[0])
        ...
        for top_4vec, pdgId in tops:
            if pdgId == 6:
                ...
                histograms['h_topPt_weightSM'].Fill(top_4vec.Pt(), lhe_weight_0[0])
                histograms['h_topEta_weightSM'].Fill(top_4vec.Eta(), lhe_weight_0[0])
                
                histograms['h_topPt_ctGRe'].Fill(top_4vec.Pt(),lhe_weight_1[0])
                histograms['h_topEta_ctGRe'].Fill(top_4vec.Eta(), lhe_weight_1[0])
                ...
                histograms['h_antitopPt_weightSM'].Fill(antitop_4vec.Pt(), lhe_weight_0[0])
                histograms['h_antitopEta_weightSM'].Fill(antitop_4vec.Eta(), lhe_weight_0[0])
                
                histograms['h_antitopPt_ctGRe'].Fill(antitop_4vec.Pt(), lhe_weight_1[0])
                histograms['h_antitopEta_ctGRe'].Fill(antitop_4vec.Eta(), lhe_weight_1[0])

            histograms['h_topMultiplicity'].Fill(top_count)
            histograms['h_topMultiplicity_weightSM'].Fill(top_count, lhe_weight_0[0])
            histograms['h_topMultiplicity_ctGRe'].Fill(top_count, lhe_weight_1[0])
            
            histograms['h_antitopMultiplicity'].Fill(antitop_count)
            histograms['h_antitopMultiplicity_weightSM'].Fill(antitop_count, lhe_weight_0[0])
            histograms['h_antitopMultiplicity_ctGRe'].Fill(antitop_count, lhe_weight_1[0])
        ...
        for b_quark in b_quarks:
            ...
            histograms['h_bquark_pt_weightSM'].Fill(b_vector.Pt(), lhe_weight_0[0])
            histograms['h_bquark_eta_weightSM'].Fill(b_vector.Eta(), lhe_weight_0[0])
            
            histograms['h_bquark_pt_ctGRe'].Fill(b_vector.Pt(), lhe_weight_1[0])
            histograms['h_bquark_eta_ctGRe'].Fill(b_vector.Eta(), lhe_weight_1[0])
        ...
        for jet_info in jets_from_w_info:
            ...
            histograms['h_jetFromW_pt_weightSM'].Fill(jet_pt, lhe_weight_0[0])
            histograms['h_jetFromW_eta_weightSM'].Fill(jet_eta, lhe_weight_0[0])
            
            histograms['h_jetFromW_pt_ctGRe'].Fill(jet_pt, lhe_weight_1[0])
            histograms['h_jetFromW_eta_ctGRe'].Fill(jet_eta, lhe_weight_1[0])
            

        histograms['h_jetMultiplicity_fromW'].Fill(jets_from_w_count)
        histograms['h_jetMultiplicity_fromW_weightSM'].Fill(jets_from_w_count, lhe_weight_0[0])
        histograms['h_jetMultiplicity_fromW_ctGRe'].Fill(jets_from_w_count, lhe_weight_1[0])
        ...
        if top_4vec and antitop_4vec:
            ...
            histograms['h_invariantMass'].Fill(ttbar.M())
            histograms['h_invariantMass_weightSM'].Fill(ttbar.M(), lhe_weight_0[0])
            histograms['h_invariantMass_ctGRe'].Fill(ttbar.M(), lhe_weight_1[0])
            ...
            if LHE_HT >= 0:                    
                ...
                if LHE_HT >= 0:
                    ...
                    if 0 <= m_tt < 500:
                        ...
                        histograms['h_LHE_HT_0_500_weightSM'].Fill(LHE_HT, lhe_weight_0[0])
                        histograms['h_LHE_HT_0_500_ctGRe'].Fill(LHE_HT, lhe_weight_1[0])
                    elif 500 <= m_tt < 750:
                        histograms['h_LHE_HT_500_750'].Fill(LHE_HT)
                        histograms['h_LHE_HT_500_750_weightSM'].Fill(LHE_HT, lhe_weight_0[0])
                        histograms['h_LHE_HT_500_750_ctGRe'].Fill(LHE_HT, lhe_weight_1[0])
                    elif 750 <= m_tt < 1000:
                        histograms['h_LHE_HT_750_1000'].Fill(LHE_HT)
                        histograms['h_LHE_HT_750_1000_weightSM'].Fill(LHE_HT, lhe_weight_0[0])
                        histograms['h_LHE_HT_750_1000_ctGRe'].Fill(LHE_HT, lhe_weight_1[0])
                    elif 1000 <= m_tt < 1500:
                        histograms['h_LHE_HT_1000_1500'].Fill(LHE_HT)
                        histograms['h_LHE_HT_1000_1500_weightSM'].Fill(LHE_HT, lhe_weight_0[0])
                        histograms['h_LHE_HT_1000_1500_ctGRe'].Fill(LHE_HT, lhe_weight_1[0])
                    elif m_tt >= 1500:
                        histograms['h_LHE_HT_1500Inf'].Fill(LHE_HT)
                        histograms['h_LHE_HT_1500Inf_weightSM'].Fill(LHE_HT, lhe_weight_0[0])
                        histograms['h_LHE_HT_1500Inf_ctGRe'].Fill(LHE_HT, lhe_weight_1[0])
        ...
        histograms['h_jet_multiplicity_last_copy_weightSM'].Fill(len(combined_jets), lhe_weight_0[0])
        histograms['h_jet_multiplicity_last_copy_ctGRe'].Fill(len(combined_jets), lhe_weight_1[0])
    
        histograms['h_jetMultiplicity'].Fill(entry.nGenJet)
        histograms['h_jetMultiplicity_weightSM'].Fill(entry.nGenJet, lhe_weight_0[0])
        histograms['h_jetMultiplicity_ctGRe'].Fill(entry.nGenJet, lhe_weight_1[0])
        ...
        if LHE_HT >= 0:
            ...
            histograms['h_mtt_vs_LHEHT_weightSM'].Fill(LHE_HT, m_tt, lhe_weight_0[0])
            histograms['h_LHE_HT_weightSM'].Fill(LHE_HT, lhe_weight_0[0])
            
            histograms['h_mtt_vs_LHEHT_ctGRe'].Fill(LHE_HT, m_tt, lhe_weight_1[0])
            histograms['h_LHE_HT_ctGRe'].Fill(LHE_HT, lhe_weight_1[0])
        ...
        if leading_jet is not None and second_leading_jet is not None:
            if leading_jet:
                ...
                histograms['h_leading_jet_pt_weightSM'].Fill(leading_jet[0].Pt(), lhe_weight_0[0])
                histograms['h_leading_jet_pt_ctGRe'].Fill(leading_jet[0].Pt(), lhe_weight_1[0])
            if second_leading_jet:
                histograms['h_second_leading_jet_pt'].Fill(second_leading_jet[0].Pt())
                histograms['h_second_leading_jet_pt_weightSM'].Fill(second_leading_jet[0].Pt(), lhe_weight_0[0])
                histograms['h_second_leading_jet_pt_ctGRe'].Fill(second_leading_jet[0].Pt(), lhe_weight_1[0])
