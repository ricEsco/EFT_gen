...
xrdcp -f /nfs/dust/cms/user/ricardo/EFT/CMSSW_10_6_26/src/EFT_gen/EFT_samples/nanogen_folder/condor/EFT_nanofiles_fully_semileptonic_multiprocess_weights_nocut.py .
