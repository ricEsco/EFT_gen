...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    #  tarball path
    args = cms.vstring('/nfs/dust/cms/user/beozek/EFT/CMSSW_10_6_27/src/EFT_gen_old/EFT_samples/nanogen_folder/nanogen_generation/NoHT/TT01j1lCA_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
    # number of events
    nEvents = cms.untracked.uint32(1000000),
    numberOfParameters = cms.uint32(1),
    outputFile = cms.string('cmsgrid_final_nocut.lhe'),
