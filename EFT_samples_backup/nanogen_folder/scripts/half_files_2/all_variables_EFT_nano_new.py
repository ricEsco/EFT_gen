...
h_leptoneta.Delete()
h_leptonphi.Delete()
h_invariantMass.Delete()
h_MET.Delete()
h_bquark_pt.Delete()
h_bquark_eta.Delete()
h_topMultiplicity.Delete()
h_leptonFlavor.Delete()
h_jetMultiplicity.Delete()
h_LHE_HTIncoming_before.Delete()
h_LHE_HTIncoming_after.Delete()
