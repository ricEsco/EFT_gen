...
file1 = ROOT.TFile.Open("/nfs/dust/cms/user/beozek/EFT/CMSSW_10_6_26/src/EFT_gen_old/EFT_samples/nanogen_folder/condor/plots_comparePowheg/output_EFT_latest.root", "READ")
# file1 = ROOT.TFile.Open("/nfs/dust/cms/user/beozek/EFT/CMSSW_10_6_26/src/EFT_gen_old/EFT_samples/nanogen_folder/condor/output_EFT_weights/output_EFT_beforeEnvelope.root", "READ")
...
("fromhardprocess", "h_jet_multiplicity_hardprocess_weightSM", "h_jet_multiplicity_hardprocess_ctGRe"),
("h_pdgId_ishardprocess", "h_jet_multiplicity_ishardprocess_weightSM", "h_jet_multiplicity_ishardprocess_ctGRe")
]
...
for hist_names in histograms_to_overlay:
    ...
    # hist1 = hist1.Rebin(2, hist1.GetName() + "_rebinned")
    # hist2 = hist2.Rebin(2, hist2.GetName() + "_rebinned")
